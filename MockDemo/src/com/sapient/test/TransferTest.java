...
public class TransferTest {
	...
	public void before() throws IdException{
		when(dao.getAccount(1001)).thenReturn(acc1);//stubbing
	...
	@Test
	public void testFund2() throws IdException, BalException{
		assertTrue(ser!=null);
		assertThrows(BalException.class,()->ser.transferFund(1003, 1002, 5000));
	}
	
	@Test
	public void testFund3() throws IdException, BalException{
		assertTrue(ser!=null);
